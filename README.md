...
**"Leaderboard" project**  is a website displays scores submitted by different players. It also allows you to submit your score. All data is preserved thanks to the external [Leaderboard API service](https://microverse.notion.site/Leaderboard-API-service-24c0c3c116974ac49488d4eb0267ade3).
...
- **Add score list with corresponding name and its score**
...
```sh
  cd Leaderboard-api
  git clone https://github.com/Fombi-Favour/Leaderboard-api.git
```
...
Feel free to check the [issues page](https://github.com/Fombi-Favour/Leaderboard-api/issues).
